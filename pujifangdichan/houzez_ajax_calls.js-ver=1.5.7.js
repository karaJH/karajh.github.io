...
//alert(data.query);
        ...
        if( is_singular_property == 'yes') {
            ...
            if( property_map != 0 ) {
                ...
                $('a[href="#gallery"]').on('http://www.pujifangdichan.com/wp-content/themes/houzez/js/shown.bs.tab', function () {
                    setTimeout(tabsHeight,500);
                });
                $('a[href="#singlePropertyMap"]').on('http://www.pujifangdichan.com/wp-content/themes/houzez/js/shown.bs.tab', function () {
                    google.maps.event.trigger(map, "resize");
                    map.setCenter(fenway);
                });
                $('a[href="#street-map"]').on('http://www.pujifangdichan.com/wp-content/themes/houzez/js/shown.bs.tab', function () {
